...
export const api_v1_swe23_list = createAsyncThunk("swe23s/api_v1_swe23_list", async payload => {
  const response = await apiService.api_v1_swe23_list(payload);
  return response.data;
});
export const api_v1_swe23_create = createAsyncThunk("swe23s/api_v1_swe23_create", async payload => {
  const response = await apiService.api_v1_swe23_create(payload);
  return response.data;
});
export const api_v1_swe23_retrieve = createAsyncThunk("swe23s/api_v1_swe23_retrieve", async payload => {
  const response = await apiService.api_v1_swe23_retrieve(payload);
  return response.data;
});
export const api_v1_swe23_update = createAsyncThunk("swe23s/api_v1_swe23_update", async payload => {
  const response = await apiService.api_v1_swe23_update(payload);
  return response.data;
});
export const api_v1_swe23_partial_update = createAsyncThunk("swe23s/api_v1_swe23_partial_update", async payload => {
  const response = await apiService.api_v1_swe23_partial_update(payload);
  return response.data;
});
export const api_v1_swe23_destroy = createAsyncThunk("swe23s/api_v1_swe23_destroy", async payload => {
...
const swe23sSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(api_v1_swe23_list.pending, (state, action) => {
